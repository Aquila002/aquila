...
class AquilaSupabaseUser extends BaseAuthUser {
  AquilaSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> aquilaSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = AquilaSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
